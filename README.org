...
[[./screenshots/magit_spellcheck.png]]
...
- Easy movement between point in the file and between other files
...
*A*: Yes! /Nothing/ binds Castlemacs to macOS except for

*Q*: Is this similar to Spacemacs?

*A*: No. Spacemacs is a big, custom distribution with additional layers on top of Emacs. Castlemacs is a simply a pre-configured Emacs. You don't need to learn anything new if you know your way around Emacs.

*Q*: Will Castlemacs support <something>?

*A*: Probably, unless it goes against the Core Principles. Feel free to open an issue.

*Q*: Does this setup work well in the terminal?

*A*: It works, but it is not built for terminal use, since one of the Core Principles is to behave like a native macOS application.
...
[[./images/nähtävyys_liikennemerkki.jpg]]
